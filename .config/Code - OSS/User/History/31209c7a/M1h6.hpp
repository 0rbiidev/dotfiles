...
class WindowManager{
    ...
    private:
     ...
     static int OnWMDdetected(Display* display, XErrorEvent* e); // detects if trying to run while another WM is running
     static bool wm_detected; // set by OnWMDetected
};